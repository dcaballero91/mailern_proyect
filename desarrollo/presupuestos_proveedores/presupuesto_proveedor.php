...
<html lang="en">
   <head>
        ...
        <title>PRESUPUESTO PROVEEDOR</title>
        ...
        <div class="right_col">
          <div class="">
            ...
            <div class="title_left">
                <h1 class="page-header" style="color: #000; font-size: 24px;" ><font  face="arial,verdana">PRESUPUESTOS DE PROVEEDORES</h1>
             </div>
...
<script src="../js/presupuestos_proveedores.js"></script> 
