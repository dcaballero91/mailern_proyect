...
<style >
    ...
    <body class="nav-md">
                ...
                <div class="right_col">
                    <div class="">
                        <div class="page-title">
                         ...
                         <h1 class="page-header" style="color: #000;" > <font  face=" Century Gothic"> Notas Compras </h1>
                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group"> 
                                                    ...
                                                    <input type="text" class="form-control" id="notamonto" placeholder="Monto" disabled="disabled">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group"> 
        ...
        <script src="../js/nota_compras.js"></script>
