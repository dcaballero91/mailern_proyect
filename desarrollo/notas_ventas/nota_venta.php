...
$con->conectar();
$tim = 6;
$nro = pg_query("SELECT ((btrim((to_char(1, '000'::text) || '-'::text)) || btrim((to_char(t.puntoexp, '000'::text) || '-'::text))) || btrim(to_char(t.tim_ultfactura, '0000000'::text))) AS ultima_factura from timbrados t WHERE timb_cod = $tim ");
$siguiente_factura = pg_fetch_assoc($nro);

$sqlTimbrado = pg_query(" SELECT timb_nro AS timbrado FROM timbrados WHERE timb_cod = $tim ");
$timbrado = pg_fetch_assoc($sqlTimbrado);
?>
<!DOCTYPE html>
<html lang="en">
    <head>
    ...
    <body class="nav-md">
                ...
                <div class="right_col">
                    <div class="">
                        <div class="page-title">
                            ...
                            <h1 class="page-header" style="color: #000;" > <font  face=" Century Gothic"> Notas Ventas</h1>
                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                   ...
                                                   <input type="text" class="form-control" value="<?php echo $siguiente_factura["ultima_factura"] ?>" id="notanumero" disabled> 
                                                </div>
                                            </div> 
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="timbrado" value="<?php echo $timbrado['timbrado'] ?>" disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control selectpicker" data-live-search="true" data-size="3"  id="clientes">
                                                        <option value="0">Elija una Opcion</option>
                                                            <?php
                                                            $var = pg_query("SELECT * FROM v_clientes");
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Nro. Factura de Venta</label>
                                                    <select  id="nrofact" class="form-control selectpicker" data-live-search="true" data-size= "5">
                                                    <option value="0">Elija primero el cliente</option>
                                                        <!-- <?php 
                                                            // $var = pg_query("select nro_factura from compras_cab where comp_estado != 'ANULADO' ");
                                                            // while($i = pg_fetch_assoc($var)){
                                                            //     echo "<option value='".$i['nro_factura']."'>".$i['nro_factura']."</option>";
                                                            // }
                                                        ?> -->
                                                    </select>
                                                </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group"> 
                                                    <label  class="control-label">Seleccionar Motivo de nota</label>
                                                    <select class="form-control selectpicker" data-live-search="true" data-size="4" id="motivo_nota" >
                                                        <option value="0">Elija una opcion</option>
                                                        <option value="DEBITO">DEBITO</option>
                                                        <option value="DESCUENTO">DESCUENTO</option>
                                                        <option value="DEVOLUCION">DEVOLUCION</option>
                                                        <option value="ANULACION">ANULACION DE FACTURA</option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="form-group"> 
                                                    ...
                                                    <input type="text" class="form-control" id="notamonto" placeholder="Monto del debito" disabled="disabled">
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                                <div class="form-group"> 
                                        ...
                                        <div class="dataTable_wrapper">
                                            <table class="table" id="ordencompras">
                                                <thead>
                                                    <tr>
                                                        <th></th>
                                                        <th width="4%">Nro. Nota</th>
                                                        <th width="10%">Nota Factura</th>
        ...
        <script src="../js/nota_ventas.js"></script>
