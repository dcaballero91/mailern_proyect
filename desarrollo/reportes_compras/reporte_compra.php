   ...
   // include "../controles/header.php";
    ...
    <div class="content container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                <h2 class="page-title">Reporte Compras</h2>
            </div>
        </div>
                ...
                <section class="widget">
                    <header>
                        <h4>
                            ...
                            Generar Reporte de las compras
                        </h4>
                    </header>
                    <div class="body">
                        <fieldset>
                                ...
                                <div class="row-fluid non-responsive">
                                    ...
                                    <div class="span3">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" id="nroFact" class="control-input" style="display:block; height:30px;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <select id="est" required="required" class="select-block-level chzn-select" tabindex="-1">
                                                    ...
                                                    <option value="PROCESADO">PAGADO</option>
...
<script src="../js/reporte_compras.js"></script>
<!-- page specific -->
