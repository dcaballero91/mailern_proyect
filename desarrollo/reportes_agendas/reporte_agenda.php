   ...
   // include "../controles/header.php";
    ...
    <div class="content container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                <h2 class="page-title">Reporte Agendas Funcionarios</h2>
            </div>
        </div>
                ...
                <section class="widget">
                    <header>
                        <h4>
                            ...
                            Generar Reporte de las agendas de funcionarios
                        </h4>
                    </header>
                    <div class="body">
                        <fieldset>
                ...
                <section class="widget">
                    <header>
                        <h4>
                            ...
                            Lista de agendas de funcionarios
                        </h4>
                    </header>
...
<script src="../js/reporte_agendas.js"></script>
<!-- page specific -->
