...
<head>
    ...
    <meta name="author" content="Alfredo Sanchez" />
    <meta charset="utf-8" />
   ...
   // include "../controles/header.php";
    ...
    <div class="content container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="span12">
                <h2 class="page-title">Reporte Pedido ventas</h2>
            </div>
        </div>
                ...
                <section class="widget">
                    <header>
                        <h4>
                            ...
                            Generar Reporte de los pedidos ventas
                        </h4>
                    </header>
                    <div class="body">
                        <fieldset>
                                            ...
                                            <div class="controls">
                                                <select id="fun" required="required" class="select-block-level chzn-select" tabindex="-1">
                                                    ...
                                                    while ($c = pg_fetch_assoc($cli)){
                                                        echo "<option value='".$c["cli_cod"]."'>".$c["cli_nom"]."</option>";
                                                    }
                                                    ?>
                                                </select>
                                            </div>
                ...
                <section class="widget">
                    <header>
                        <h4>
                            ...
                            Lista de los pedidos de ventas
                        </h4>
                    </header>
